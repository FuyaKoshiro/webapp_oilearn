...
# conn = sqlite3.connect("common/models/database.db", check_same_thread=False)
# cursor = conn.cursor()
...
#         cursor.execute("SELECT * FROM users WHERE user_email = ?", (email_input,))
#         response = cursor.fetchall()

#         if response[0][3] == password_input:
#             print("succeed to log-in")
